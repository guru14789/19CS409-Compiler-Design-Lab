...
## AIM   
To write a C program for the Conversion of Non-Deterministic Finite Automaton (NFA) To Deterministic Finite Automaton (DFA).

## ALGORITHM
Step 1 : Take ∈ closure for the beginning state of NFA as the beginning state of DFA. 
...
Step 4 : Do repeat Step 2 and Step 3 until no new state is present in DFA transition table. 

Step 5 : Mark the states of DFA which contains the final state of NFA as final states of DFA.
...
## OUTPUT 
![image](https://github.com/guru14789/19CS409-Compiler-Design-Lab/assets/151705853/3deb82c6-cb33-490b-833d-753aa9705890)


## RESULT
A program to convert NFA to DFA has been implemented.
